...
DOCKER_ENV_FILE = BASE_DIR / "../docker/.env"

if not load_dotenv(DEFAULT_ENV_FILE) and not load_dotenv(DOCKER_ENV_FILE):
...
SECRET_KEY = "django-insecure-$zyoy2)5p856pa-da+=_@$%xg@%_k_#!qttp%1sx-&@%_=!8d+"
